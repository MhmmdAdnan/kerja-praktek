...
if (isset($_POST['go'])) {
  $cari = $_POST['cari'];
  $siswa = mysqli_query($koneksi, "SELECT * FROM tb_jurusan WHERE nama LIKE '%" . $cari . "%'");
} else {
  $siswa = mysqli_query($koneksi, "SELECT * FROM tb_jurusan LIMIT $halaman_awal, $batas");
}
...
?>
  ...
  <tr>
    ...
    <td><button class="btn btn-danger" data-toggle="modal" data-target="#hapus_jurusan<?= $pro['id']; ?>"><i class="fa fa-trash"></i></button>
      <div class="modal fade" id="hapus_jurusan<?= $pro['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
              <form action="" method="POST">
                ...
                <div class="form-group">
                  <label>Program Studi</label>
                  <input class="form-control" type="text" name="jurusan" value="<?= $pro['jurusan']; ?>">
                </div>
