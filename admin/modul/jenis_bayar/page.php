...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-1" style="padding-bottom: 20px;">Data SPP</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-12"><br>
            ...
            <button type="button" class="btn btn-primary mb-5 ml-5" data-toggle="modal" data-target="#exampleModal">
              <i class="fa fa-trash"></i> Tambah Data SPP
            </button>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    Apakah Anda yakin ingin menghapus semua DATA SPP ?
                  </div>
              ...
              <ul class="pagination justify-content-center">
                <li class="page-item">
                  <a class="page-link" <?php if ($halaman > 1) {
                                          echo "href='?m=jenis_bayar&halaman=$previous'";
                                        } ?>>Previous</a>
                </li>
                <?php
                ...
                <li class="page-item">
                  <a class="page-link" <?php if ($halaman < $total_halaman) {
                                          echo "href='?m=jenis_bayar&halaman=$next'";
                                        } ?>>Next</a>
                </li>
              </ul>
            </center>
