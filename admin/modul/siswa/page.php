...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-1" style="padding-bottom: 20px;">Data Siswa</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select name="jurusan" class="form-control">
                          ...
                          global $koneksi;
                          $select = mysqli_query($koneksi, "SELECT * FROM tb_jurusan");
                          foreach ($select as $r) :
                          ?>
                            <option value="<?= $r['jurusan']; ?>"><?= $r['jurusan']; ?></option><?php endforeach; ?>
                        </select>
                      </div>
              ...
              <ul class="pagination justify-content-center">
                <li class="page-item">
                  <a class="page-link" <?php if ($halaman > 1) {
                                          echo "href='?m=siswa&halaman=$previous'";
                                        } ?>>Previous</a>
                </li>
                <?php
                ...
                <li class="page-item">
                  <a class="page-link" <?php if ($halaman < $total_halaman) {
                                          echo "href='?m=siswa&halaman=$next'";
                                        } ?>>Next</a>
                </li>
              </ul>
            </center>
