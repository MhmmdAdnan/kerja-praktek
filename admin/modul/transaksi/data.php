					...
					<tr>
						...
						<td>
							<div class="input-group mb-2">
								...
								<input type="text" class="form-control xs-2" id="bayar2" name="bayar" value="<?= $row['nominal']; ?>">
							</div>
						</td>
						<td>
							<p style="color: red;"><i>BAYAR SPP SISWA !!!</i></p>
						</td>
					</tr>
					<tr>
			...
			<tbody>
				...
				?>
					...
					<tr>
						...
						<td>
							<button class="btn btn-danger" data-toggle="modal" data-target="#hapus_spp<?= $key['id']; ?>"><i class="fa fa-trash"></i></button>
							<div class="modal fade" id="hapus_spp<?= $key['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
