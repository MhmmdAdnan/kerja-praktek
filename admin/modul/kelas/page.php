...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-1" style="padding-bottom: 20px;">Data Kelas</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    Apakah Anda yakin ingin menghapus semua DATA KELAS ?
                  </div>
              ...
              <ul class="pagination justify-content-center">
                <li class="page-item">
                  <a class="page-link" <?php if ($halaman > 1) {
                                          echo "href='?m=kelas&halaman=$previous'";
                                        } ?>>Previous</a>
                </li>
                <?php
                ...
                <li class="page-item">
                  <a class="page-link" <?php if ($halaman < $total_halaman) {
                                          echo "href='?m=kelas&halaman=$next'";
                                        } ?>>Next</a>
                </li>
              </ul>
            </center>
